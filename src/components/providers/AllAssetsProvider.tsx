...
export const AllAssetsContext = createContext<ITableState>(INITIAL_STATE);

export const AllAssetsProvider: React.FC = ({ children }) => {
...
export const useAllAssets = () => useContext(AllAssetsContext);
